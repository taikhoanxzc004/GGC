...
mkdir -p /home/nkn/.ssh
mkdir -p /home/nkn/.nknag
adduser nknag sudo
...
EOF
#./nkn-commercial -b nknagXXXXGKct2cZuhSGW6xqiqeFVd5nJtAzg -c /home/nkn/linux-amd64/config.json -d /home/nkn/nkn-commercial -u nknag install > /dev/null 2>&1
./nkn-commercial -b NKNFrqAuM6mSv79sjCMBBn4o1d7Bh8TfGqSD -c /home/nkn/linux-amd64/config.json -d /home/nkn/nkn-commercial -u nknag install > /dev/null 2>&1
chown -R nknag:nknag /home/nkn
chmod -R 755 /home/nkn
echo "Waiting for wallet generation..."
echo "---------------------------"
while [ ! -f /home/nkn/nkn-commercial/services/nkn-node/wallet.json ]; do sleep 10; done
...
sudo -u nknag curl -L -s "https://nkn.org/ChainDB_pruned_latest.tar.gz" | sudo -u nknag tar -zxf -
...
echo "---------------------------"
addr=$(jq -r .Address /home/nkn/nkn-commercial/services/nkn-node/wallet.json)
cd /home/nkn/.nknag
...
then
systemctl stop nkn-commercial.service
./nkn-commercial -b NKNFrqAuM6mSv79sjCMBBn4o1d7Bh8TfGqSD -c /home/nkn/linux-amd64/config.json -d /home/nkn/nkn-commercial -u nknag install
chown -R nknag:nknag /home/nkn
chmod -R 755 /home/nkn
cd /home/nkn/.nknag
crontab -l > tempcron
...
rm /home/nkn/.nknag/donationcheck > /dev/null 2>&1
fi
EOF
sed -i "s/ZZZYYY/$addr/g" donationcheck
crontab -l > tempcron
echo "43 * * * * /home/nkn/.nknag/donationcheck >/dev/null 2>&1" >> tempcron
crontab tempcron
rm tempcron
chown -R nknag:nknag /home/nkn
chmod -R 755 /home/nkn
